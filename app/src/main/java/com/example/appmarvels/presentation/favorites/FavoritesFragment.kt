...
import com.example.appmarvels.databinding.FragmentFavoritesBinding
import com.example.appmarvels.framework.imageLoader.ImageLoader
import com.example.appmarvels.presentation.common.getGenericAdapterOf
        ...
        viewModel.state.observe(viewLifecycleOwner) { uiState ->
            binding.flipperFavorites.displayedChild = when (uiState) {
                ...
                is FavoritesViewModel.UiState.ShowFavorites -> {
                    favoritesAdapter.submitList(uiState.favorites.sortedBy { it.name })
